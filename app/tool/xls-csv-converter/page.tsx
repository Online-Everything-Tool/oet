...
import XlsCsvConverterClient from './_components/XlsCsvConverterClient';
import type { ToolMetadata } from '@/src/types/tools';
import { toolRoute } from '@/app/lib/utils';

export default function XlsCsvConverterPage() {
  ...
  return (
    <div className="relative flex flex-col gap-4">
      ...
      <ToolSuspenseWrapper>
        <XlsCsvConverterClient toolRoute={toolRoute(typedMetadata)} />
      </ToolSuspenseWrapper>
    </div>
  );
}