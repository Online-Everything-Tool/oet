...
export default function ImageBlurClient({ toolRoute }: ImageBlurClientProps) {
  ...
  const blurImageDrawFunction = useCallback(
  ...
  }, [toolState.selectedFileId, toolState.blurAmount, toolState.processedFileId, toolState.autoSaveProcessed, isLoadingToolSettings, isProcessingImage, processImage, blurImageDrawFunction, getFile, setState, processingErrorHook, generateDefaultOutputFilename]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-1">
          <label className="block text-sm font-medium text-[rgb(var(--color-text-muted))]">
            Original Image{' '}
            {originalFilenameForDisplay && (<span className="font-normal text-xs">({originalFilenameForDisplay})</span>)}
          </label>
