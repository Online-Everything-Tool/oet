      ...
      <div className="p-4 border border-[rgb(var(--color-border-base))] rounded-md bg-[rgb(var(--color-bg-subtle))]">
        ...
        <div className="flex flex-wrap gap-2">
          {CASE_TYPES.map((ct, index) => {
            ...
            const baseClasses =
              'px-3 py-1.5 rounded-md text-sm font-medium border-2 transition-colors duration-150 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-1';
