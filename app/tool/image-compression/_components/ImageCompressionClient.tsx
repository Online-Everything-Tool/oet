// FILE: app/tool/image-compression/_components/ImageCompressionClient.tsx
'use client';
import React from 'react';

export default function ImageCompressionClient({ toolRoute }: { toolRoute: string }) {
  ...
  return (
    <div>
      <h2>Hello from ImageCompressionClient! (Tool Route: {toolRoute})</h2>
