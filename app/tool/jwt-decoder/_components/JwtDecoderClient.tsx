    ...
    const handleDecode = useCallback(() => {
        ...
        try {
            ...
            addHistoryEntry({
                ...
                trigger: 'click',
                input: { jwt: jwt.length > 500 ? jwt.substring(0, 500) + '...' : jwt },
                output: { error: err instanceof Error ? err.message : 'Invalid JWT' },
                status: 'error',
            });
        }
        ...
        <div className="flex flex-col gap-4 text-[rgb(var(--color-text-base))]">
            ...
            {decodedJwt && (
                <div>
                    ...
                    <pre id="jwt-output" className="p-3 border border-[rgb(var(--color-input-border))] bg-[rgb(var(--color-bg-subtle))] text-[rgb(var(--color-input-text))] rounded-md shadow-sm text-sm font-mono whitespace-pre-wrap">
