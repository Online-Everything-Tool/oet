    ...
    <div className="flex flex-col gap-6 text-[rgb(var(--color-text-base))]">
      ...
      {initialEntities.length > 0 && (
        <p className="text-sm text-[rgb(var(--color-text-muted))]">
          ...
          {!selectedCategory && !searchTerm && initialEntities.length > 0
          ...
          {filteredEntities.map((entity) => (
            ...
            >
              ...
              <div className="text-center text-sm space-y-1 w-full">
                <p
                  className="text-[rgb(var(--color-text-muted))] truncate h-5"
                  title={entity.description || 'No description available'}
                >
                  {' '}
                  {entity.description || <> </>}{' '}
                </p>
