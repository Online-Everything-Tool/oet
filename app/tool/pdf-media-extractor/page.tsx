...
import PdfMediaExtractorClient from './_components/PdfMediaExtractorClient';
import { ToolMetadata } from '@/src/types/tools';
import { toolRoute } from '@/app/lib/utils';

export default function PdfMediaExtractorPage() {
  ...
  return (
    <div className="relative flex flex-col gap-4">
      ...
      <ToolSuspenseWrapper>
        <PdfMediaExtractorClient toolRoute={toolRoute(typedMetadata)} />
      </ToolSuspenseWrapper>
    </div>
  );
}
